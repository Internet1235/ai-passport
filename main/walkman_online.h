...
typedef struct { unsigned net_stack,ws_stack,error_code,failures,phase,seconds,dropped,played,starves,wifi_reason,captured,uploaded,upload_ms; bool configured,wifi,recording,testing,connected; char message[128],text[1801]; } wn_state;
void wn_start(void);
